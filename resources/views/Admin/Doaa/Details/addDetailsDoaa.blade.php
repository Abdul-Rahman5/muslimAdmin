        ...
        <div class="row g-4">
            <div class="col-sm-12 ">
                <div class="bg-light rounded h-100 p-4">
                    <h2 class="mb-4">Add Details Doaa</h2>
                    @include('errors')
                    <form method="POST" action="{{ url('storeDetailsDoaa') }}" autocomplete>
                        @csrf
                    ...
                    <div class="info d-flex">
                        ...
                        <div class="mb-3 w-50 mx-2">
                            ...
                            <select name="category_doaas_id" class="form-select mb-3" aria-label="Default select example">
