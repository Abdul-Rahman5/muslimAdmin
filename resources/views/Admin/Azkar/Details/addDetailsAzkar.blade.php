        ...
        <div class="row g-4">
            <div class="col-sm-12 ">
                <div class="bg-light rounded h-100 p-4">
                    <h2 class="mb-4">Add Details Azkar</h2>
                    @include('errors')
                    <form method="POST" action="{{ url('storeDetailsAzkar') }}" autocomplete>
                        @csrf
                    ...
                    <div class="info d-flex">
                        ...
                        <div class="mb-3 w-50 mx-2">
                            ...
                            <textarea class="form-control " name="reward_ar" id="reward_ar" cols="30" rows="3"></textarea>

                        </div>
                        <div class="mb-3 w-50 mx-2">
                            <label for="reward_en" class="form-label">Reward en :</label>
                            <textarea class="form-control " name="reward_en" id="reward_en" cols="30" rows="3"></textarea>
                        </div>
                    ...
                    <div class="info d-flex">
                        ...
                        <div class="mb-3 w-50 mx-2">
                            ...
                            <input name="repeat" type="number" class="form-control me-2 " id="Repeat">
                        </div>
                        <div class="mb-3 w-50 mx-2">
                            <label for="Repeat" class="form-label">Caregories :</label>

                            <select name="cateogry_azkars_id" class="form-select mb-3" aria-label="Default select example">
